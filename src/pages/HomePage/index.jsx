        ...
        <Div className="home-grid">
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://thumbs.dreamstime.com/b/o-car%C3%A1ter-medieval-do-jogo-rpg-da-a%C3%A7%C3%A3o-fantasia-espada-protetor-cavaleiro-guerreiro-isolou-ilustra%C3%A7%C3%A3o-vetor-%C3%ADcone-122624694.jpg"
                alt="Perfil"
              />
            </Div>
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://img.freepik.com/vetores-premium/design-de-logotipo-de-icone-de-monstro_775854-1726.jpg"
                alt="Bestiário"
              />
            </Div>
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://img.magnific.com/vetores-gratis/icones-do-jogo-com-navio-de-pocao-de-espada-de-capacete-viking_107791-13243.jpg?semt=ais_hybrid&w=740&q=80"
                alt="Itens"
              />
            </Div>
            ...
            <Div className="titulo-home">
              <h3>
                Explore equipamentos, tesouros e artefatos para sua jornada.
              </h3>
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQPP6c7vS8bYfxPxEtrdnmOLbvlRHfJESiBQ&s"
                alt="Mesa"
              />
            </Div>
            ...
            <Div className="titulo-home">
              <h3>
                Crie um mundo, convide seus heróis e conte uma história épica.
              </h3>
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://st3.depositphotos.com/7438112/14031/v/450/depositphotos_140318540-stock-illustration-form-icon-on-white-background.jpg"
                alt="Ficha"
              />
            </Div>
          ...
          <Div className="card-home">
            <Div className="avatar-circular">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWXabDIT3M_z35MUkaVDQxzZF4wy1NObBBSd6VYqH0Xw&s"
                alt="Mestre"
              />
            </Div>
